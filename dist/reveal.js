...
!(function (e, t) {
  ...
  function Y(a, l) {
    ...
    function Ce() {
      E.postMessage && window.addEventListener("message", jt, !1);
    }
    function xe(t) {
      const n = { ...E };
    ...
    function Pe() {
      window.addEventListener("resize", Kt, !1),
        ...
        Y.slides.addEventListener("transitionend", Ut, !1),
    ...
    function Ne() {
      pe.unbind(),
        ...
        Y.slides.removeEventListener("transitionend", Ut, !1),
    ...
    function Me() {
      Ne(),
        ...
        window.removeEventListener("message", jt, !1),
    ...
    function De(e) {
      "string" == typeof e.layout && (U.layout = e.layout),
        ...
        U.layout
          ? s(Y.slides, U.layout + " " + U.overview)
          : s(Y.slides, U.overview);
    }
    ...
    function qe(e) {
      "boolean" == typeof e ? (e ? je() : Ue()) : Y.overlay ? Ue() : je();
    }
    function je() {
      if (E.help) {
        Ue(),
      ...
      if (Y.wrapper && !ge.isPrintingPDF()) {
        if (!E.disableLayout) {
          ...
          Ke(E.width, E.height),
            ...
            (j = Math.max(j, E.minScale)),
            (j = Math.min(j, E.maxScale)),
            1 === j
              ? ((Y.slides.style.zoom = ""),
                (Y.slides.style.left = ""),
                (Y.slides.style.top = ""),
              ...
              : ((Y.slides.style.zoom = ""),
                ...
                De({ layout: "translate(-50%, -50%) scale(" + j + ")" }));
          ...
          t !== j &&
            Fe({ type: "resize", data: { oldScale: t, scale: j, size: e } });
        }
        Y.viewport.style.setProperty("--slide-scale", j),
          ce.update(),
          se.updateParallax(),
    ...
    function Ve(e, t) {
      ...
      return (
        (i.presentationWidth -= i.presentationWidth * E.margin),
        (i.presentationHeight -= i.presentationHeight * E.margin),
